...
const WhoIsI = () => {
    const blockRoom = (
        ...
        return(
        <div data-aos="fade-up" className="privateRooms" style={{flexDirection: flexDirectionValue}}>
            <img src={img} alt={`${img}`}/>
    ...
    return(
        <div className="whoIsI_layout">
            <p data-aos="fade-up" id="section2" className="whoIsI_header">Что я умею?</p>
            ...
            <p data-aos="fade-up" className="whoIsI_header">И многое другое!</p>
        </div>
    )
}
